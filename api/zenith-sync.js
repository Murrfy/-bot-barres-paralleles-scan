    ...
    if (action === 'real-execution-arm' && req.method === 'POST') {
      ...
      if (armCommitResult !== 1) {
        ...
        const requesterReason = device.role === 'controller'
          ? (armCommitResult === -8 ? 'CONTROLLER_SESSION_REVOKED' : 'CONTROLLER_ROLE_CHANGED')
          : (armCommitResult === -8 ? 'MASTER_SESSION_REVOKED' : 'MASTER_ROLE_CHANGED');
              ...
              : armCommitResult === -4
                ...
                : armCommitResult === -5
                  ...
                  : armCommitResult === -6
                    ...
                    : armCommitResult === -7 || armCommitResult === -8
                      ? requesterReason
