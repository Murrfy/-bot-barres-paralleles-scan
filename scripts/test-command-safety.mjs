...
const { commandTypeAllowed, commandExpired, executionGate, deferredCommandPayload, commandFailureNeedsEmergencyStop } = await import(
  'data:text/javascript;base64,' +
  Buffer.from(source + '\nexport { commandTypeAllowed, commandExpired, executionGate, deferredCommandPayload, commandFailureNeedsEmergencyStop };').toString('base64')
);
