...
test('legacy Bearer never bypasses same-origin mutation protection', () => {
  assert.equal(sameOriginMutation({method:'POST',headers:{authorization:'Bearer legacy-token'}}),false);
});
