...
test('tick rounding never makes the actual loss exceed the requested hard cap',()=>{
  const plan=buildEntryProtectionPlan({
    commandId:'entry-round-12345',
    symbol:'BTCUSDT',
    side:'BUY',
    quantity:3,
    limitPrice:100,
