...
const sensitiveAssignment = new RegExp(
  String.raw`(?:BINANCE_API_KEY|BINANCE_API_SECRET|BINANCE_TRADING_API_KEY|BINANCE_TRADING_API_SECRET|UPSTASH_REDIS_REST_TOKEN|KV_REST_API_TOKEN|ZENITH_MASTER_ADMIN_CODE|ZENITH_MASTER_PAIRING_CODE|ZENITH_PAIRING_CODE|VERCEL_TOKEN)\s*[:=]\s*['"]([^'"]{4,})['"]`,
  'g'
);
