...
const snapshot={
  ...
  positions:[{symbol:'BTCUSDT',positionSide:'BOTH',positionAmt:'0.02',entryPrice:50000,breakEvenPrice:50001,unrealizedProfit:2,marginType:'isolated',isolatedMargin:100}],
