...
export function buildControllerUpdateExitCommand(position, targetPrice, previousClientOrderId = '') {
  ...
  return {
    ...
    clientCommandId: updateCommandId('exit', live, target, previous),
    payload: {
      symbol: live.symbol,
...
export function buildControllerUpdateProtectionCommand(
  ...
  return {
    ...
    clientCommandId: updateCommandId(kind === 'MAX_LOSS' ? 'maxloss' : 'protect', live, trigger, previous),
    payload: {
      symbol: live.symbol,
      direction: live.direction,
      quantity: live.quantity,
